...
if (isset($_SESSION['id_user'])) {
    ...
    // get the HTML
    ob_start();
    $conn = $_mysqli->query("SELECT * FROM tb_pesan, tb_kelas, tb_keberangkatan, tb_user WHERE tb_pesan.id_user=tb_user.id_user AND
						tb_pesan.id_kelas=tb_kelas.id_kelas AND tb_pesan.id_keberangkatan=tb_keberangkatan.id_keberangkatan AND id_pesan=" . $_GET['id']);
    $isi_tbl = mysqli_fetch_array($conn);
...
?>
    ...
    <page format="105x200" orientation="L" backcolor=" ##e6a429 " style="font: arial;">
