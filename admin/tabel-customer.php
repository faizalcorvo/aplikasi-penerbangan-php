                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><img src="../assets/images/users/<?php echo $id['foto']; ?>" width="40" height="40" alt=""></td>
                                                    <td><?php echo $id['nama_user']; ?></td>
                                                    <td><?php echo $id['email_user']; ?></td>
                                                    <td><?php echo $id['no_hp']; ?></td>
                                                    <td><?php echo $id['username']; ?></td>
                                                    <td><?php echo $id['password']; ?></td>
                                                    <td><?php echo $id['akses']; ?></td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteuser<?php echo $id['id_user']; ?>"><i class="fa fa-trash-alt"></i>
                                                        </button>
                                                        <!-- Modal delete-->
                                                        <div class="modal fade" id="deleteuser<?php echo $id['id_user']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header bg-info">
                                                                        <h5 class="modal-title fw-bold text-white" id="exampleModalLabel">
                                                                            <i class="fa fa-trash-alt"></i> &nbsp; Konfirmasi Hapus Data Customer
                                                                        </h5>
                                                                        <button class="btn-close btn-close-white" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <h4 align="center">Apakah anda yakin ingin menghapus user id <?php echo $id['id_user']; ?><strong><span class="grt"></span></strong> ?</h4>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                                                        <a href="prosesPengguna/proses.php?act=deleteuser&id=<?php echo $id['id_user']; ?>" class="btn btn-info">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
